...
router.put('/update-profile', protect, async (req, res) => {
  try {
    const { userId, username, email, avatar, petAccessories } = req.body;
    ...
    if (petAccessories !== undefined) {
      const safeAccessories = (petAccessories && typeof petAccessories === 'object')
        ? {
            hat: petAccessories.hat || null,
            hair: petAccessories.hair || null,
            glasses: petAccessories.glasses || null,
            face: petAccessories.face || null
          }
        : { hat: null, hair: null, glasses: null, face: null };
      updates.petAccessories = safeAccessories;
    }
